...
let clientBuilder = new SmartyStreetsCore.ClientBuilder(new SmartyStreetsCore.StaticCredentials(authID,authToken))    //Create your own account
        ...
        connection.query(check_listing,[street_address,city,state],function(err,result){
          ...
          client.send(lookup)
            ...
            .catch((response) => {
              ...
              console.log("Error with smarty API. Try again at a different time!",response);
            })
        });
      }
    });
